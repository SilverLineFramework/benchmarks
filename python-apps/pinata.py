...
HIT_RELOAD= 2         # how many hits does it take
#G_ACCEL = -9.8
#HIT_IMPULSE = 20
G_ACCEL = -19.8
...
def main():
    ...
    hit_text = Text(object_id=pinata_id + "_hit_text", persist=True, text=str(hit_counter), scale=Scale(3,3,3), position=Position(0.5,5,0), parent=pinata)
