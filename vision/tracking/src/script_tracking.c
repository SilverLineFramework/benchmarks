...
int benchmark_main(int argc, char* argv[])
{
    ...
    #if SIZE == 0
    char base[100] = "data/vision/tracking/sqcif";
    char im1[100] = "data/vision/tracking/sqcif/1.bmp";
    #elif SIZE == 1
    char base[100] = "data/vision/tracking/qcif";
    char im1[100] = "data/vision/tracking/qcif/1.bmp";
    #else
    char base[100] = "data/vision/tracking/cif";
    char im1[100] = "data/vision/tracking/cif/1.bmp";
    #endif
...
{
    /** Read image **/
    sprintf(im1, "%s/%d.bmp", base, count);
    Ic = readImage(im1);
    rows = Ic->height;
    cols = Ic->width;
