...
typedef  struct corner{int x,y,info, dx, dy, I;};
...
int    *r,
       ...
       mode = 0, i,
       x_size, y_size;
struct corner *corner_list = malloc(sizeof(struct corner) * MAX_CORNERS);
/* }}} */

    #ifdef LARGE
    char filename[200] = "data/mibench/automotive/input_large.pgm";
    #else
    char filename[200] = "data/mibench/automotive/input_small.pgm";
    #endif
