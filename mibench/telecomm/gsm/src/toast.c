...
int benchmark_main P2((ac, av), int ac, char **av)
{
	int  		opt;
	extern int	optind;
    ...
    #ifdef ENCODE
        #ifdef LARGE
        process("data/mibench/telecomm/large.au");
        #else
        process("data/mibench/telecomm/small.au");
        #endif
    #else
        #ifdef LARGE
        process("data/mibench/telecomm/large.au.run.gsm");
        #else
        process("data/mibench/telecomm/small.au.run.gsm");
        #endif
    #endif
